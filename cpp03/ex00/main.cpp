...
int main( void ) {
	{
		...
		std::cout << "getName(): " << defaultClap.getName() << std::endl;
		std::cout << "getEnergy(): " << defaultClap.getEnergyPoint() << std::endl;
		std::cout << "getHitPoint(): " << defaultClap.getHitPoint() << std::endl;
		std::cout << "getAttackDamage(): " << defaultClap.getAttackDamange(0) << std::endl;
	...
	}
	{
		...
		c2.takeDamage(c1.getAttackDamange(0));
		c1.print("c1");
